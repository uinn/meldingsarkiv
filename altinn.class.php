...
const AUTH_URL = "/api/authentication/authenticatewithpassword?ForceEIAuthentication";
const LIST_URL = "/api/:who/Messages?$filter=ServiceCode eq '4503'";
const MGS_URL = "/api/:who/messages/:messageId/attachments";
const ATT_URL = "/api/:who/messages/:messageId/attachments/:attatchemtId";
